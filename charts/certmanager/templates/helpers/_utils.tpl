...
{{ include "certmanager.image" ( dict "img" .Values.path.to.the.image "ctx" $ ) }}
*/}}
...
kind: {{ include "certmanager.workloadKind" ( dict "kind" .Values.workload.kind ) }}
*/}}
{{- define "certmanager.workloadKind" -}}
{{- $kind := .kind | lower -}}
